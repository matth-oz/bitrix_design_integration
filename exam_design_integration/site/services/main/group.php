...
if(IntVal($userGroupID) > 0)
{
	...
	WizardServices::SetFilePermission(Array($siteID, $SiteDir . "/partner/"), Array($userGroupID => "W"));
	...
	WizardServices::SetFilePermission(Array($siteID, $SiteDir . "/user/"), Array($userGroupID => "W"));
}
?>