...
$iblockCode = "furniture_reviews_".WIZARD_SITE_ID;
$iblockType = "content";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/company/reviews/index.php", array("REVIEWS_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/company/reviews/detail.php", array("REVIEWS_IBLOCK_ID" => $iblockID));
$bitrixTemplateDir = $_SERVER["DOCUMENT_ROOT"].BX_PERSONAL_ROOT."/templates/";
// С€Р°Р±Р»РѕРЅ - main/header.php
CWizardUtil::ReplaceMacros($bitrixTemplateDir."main/header.php", array("REVIEWS_IBLOCK_ID" => $iblockID));
// С€Р°Р±Р»РѕРЅ - inner/header.php
CWizardUtil::ReplaceMacros($bitrixTemplateDir."inner/footer.php", array("REVIEWS_IBLOCK_ID" => $iblockID));
?>