...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/promos.xml";
$iblockCode = "furniture_promos_".WIZARD_SITE_ID;
$iblockType = "content";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/stock/index.php", array("PROMOS_IBLOCK_ID" => $iblockID));
$bitrixTemplateDir = $_SERVER["DOCUMENT_ROOT"].BX_PERSONAL_ROOT."/templates/";
// С€Р°Р±Р»РѕРЅ - inner/footer.php
CWizardUtil::ReplaceMacros($bitrixTemplateDir."inner/footer.php", array("PROMOS_IBLOCK_ID" => $iblockID));
?>